# Tugas us membuat calculator menggunkan thinker
from tkinter import*
import math
...
#kayanya ini buat metiin auto sizenya? 
...
# child of coverFrame
coverMainFrame = Frame (coverFrame, bd=10, pady=2, bg='Tomato', relief=RIDGE)
coverMainFrame.grid()
...
class Calculator():
       ...
       # membuat function agar button nya mulai berfungsi
       # num:parameter
       def numberEnter(self,num):
              self.result = False
              firstnum = entDisplay.get() #get:menampilkanvalue yang kita masukan
              secondnum = str(num)
              if self.input_value:
...
for j in range(3,6):
       ...
       # BACKSPACE
       # membuat button backspace, child dari mainFrame ((biar si backspacenya itu didlam grid MainFrame))
       btnBackSpace=Button(MainFrame, width=6, height=2, font=('arial',16,'bold'),bd=4, text="←" , bg='Salmon'
       ...
       # CLEAR
       btnClear=Button(MainFrame, width=6, height=2, font=('arial',16,'bold'),bd=4, text=chr(67) , bg='Salmon'
                       , command = added_value.Clear_Entry)
       # chr(67) itu diambil dari tabel kode karakter unicode
       #posisi buttonnya
       btnClear.grid(row=1,column=1,pady=1)
   
       
       btnClearAll=Button(MainFrame, width=6, height=2, font=('arial',16,'bold'),bd=4, text=chr(67)+chr(69) , bg='Salmon'
                         , command = added_value.all_Clear_Entry )
       #posisi buttonnya
       btnClearAll.grid(row=1,column=2,pady=1)
   
       btnPM=Button(MainFrame, width=6, height=2, font=('arial',16,'bold'),bd=4, text=chr(177) , bg='Salmon'
...
# ===================================================================================================================================================
       ...
       btnTan=Button(MainFrame, width=6, height=2, font=('arial',16,'bold'),bd=4, text="Tan", bg='Salmon'
                    , command = added_value.tan)
       #posisi buttonnya
       btnTan.grid(row=2,column=3,pady=1)
# ===============================================================SCIENTIFIC============================================================================
       btnTambah=Button(MainFrame, width=6, height=2, font=('arial',16,'bold'),bd=4, text="+" , bg='Salmon'
                        , command = lambda:added_value.operation("Add"))
       #posisi buttonnya
       btnTambah.grid(row=3,column=3,pady=1)

       # Pengurangan
       btnPengurangan=Button(MainFrame, width=6, height=2, font=('arial',16,'bold'),bd=4, text="-" , bg='Salmon'
                            , command = lambda:added_value.operation("Pengurangan"))
       #posisi buttonnya
       btnPengurangan.grid(row=4,column=3,pady=1)

       # Perkalian
       btnKali=Button(MainFrame, width=6, height=2, font=('arial',16,'bold'),bd=4, text="*" , bg='Salmon'
                       , command = lambda:added_value.operation("Kali"))
       #posisi buttonnya
       btnKali.grid(row=5,column=3,pady=1)

       # Pembagian
       btnPembagian=Button(MainFrame, width=6, height=2, font=('arial',16,'bold'),bd=4, text=chr(247) , bg='Salmon'
                           , command = lambda:added_value.operation("Bagi"))
       #posisi buttonnya
       btnPembagian.grid(row=6,column=3,pady=1)

       btnZero=Button(MainFrame, width=6, height=2, font=('arial',16,'bold'),bd=4, text="0" , bg='Salmon'
                       , command = lambda:added_value.numberEnter(0))
       #posisi buttonnya
       btnZero.grid(row=6,column=0,pady=1)

       btnDesimal=Button(MainFrame, width=6, height=2, font=('arial',16,'bold'),bd=4, text="." , bg='Salmon'
                          , command = lambda:added_value.numberEnter("."))
       #posisi buttonnya
       btnDesimal.grid(row=6,column=1,pady=1)

       btnHasil=Button(MainFrame, width=6, height=2, font=('arial',16,'bold'),bd=4, text="=" , bg='Salmon'
