...
text=chr(67)+chr(69),bg='cadet blue')
...
btnDiv = Button(MainFrame, width=6, height=2, font=('arial', 16, 'bold'), bd=4, text=chr(274),
bg='cadet blue')
...
btnEquals = Button(MainFrame, width=6, height=2, font=('arial', 16, 'bold'), bd=4, text="Sin",
bg='cadet blue')
